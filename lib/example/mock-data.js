...
const zk_program_1 = require("../zk-program");
const createMockData = (sig, pubKey, msg) => {
    ...
    const publicKey = zk_program_1.Secp256k1.fromEthers(p);
    const signature = zk_program_1.Ecdsa.fromHex(s);
    const message = zk_program_1.Bytes32.fromHex(m.slice(2));
    const zkPassData = {
